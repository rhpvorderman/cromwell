...
case class WomString(value: String) extends WomPrimitive {
  ...
  override def add(rhs: WomValue): Try[WomValue] = rhs match {
    ...
    case r: WomUnlistedDirectory => Success(WomString(value + r.value))
    case r: WomSingleFile => Success(WomString(value + r.value))
    case r: WomGlobFile => Success(WomString(value + r.value))
  ...
  override def equals(rhs: WomValue): Try[WomBoolean] = rhs match {
    case r: WomUnlistedDirectory => Success(WomBoolean(value == r.value))
    case r: WomSingleFile => Success(WomBoolean(value == r.value))
    case r: WomGlobFile => Success(WomBoolean(value == r.value))
